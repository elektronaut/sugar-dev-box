...
sudo -u postgres createdb -O vagrant sugar_development
...
GRANT ALL PRIVILEGES ON sugar_development.* to 'rails'@'localhost';
GRANT ALL PRIVILEGES ON sugar_test.* to 'rails'@'localhost';
SQL
